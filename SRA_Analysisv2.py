...
def main():
    ...
    # ./YYYYMMDD/Assembled
    # assembly_date.py
    assem_cmd = "python3 Assembly_date_noDownload.py --PDAT {} --output {}".format(date, outdir)
    print("\n\n\n")
    print(assem_cmd)
    print("**********************************  ASSEMBLED  **********************************\n")
    ...
    for g in genomes[gnum:]:
        ...
        qual_cmd = "python3 QualityCheckv3-124.py -r {} -g {} -db {} -m {} -o {}".format(ref_dir, g, buscoDB, buscoMode, outdir)
        print("run cmd: {}\n".format(qual_cmd))
